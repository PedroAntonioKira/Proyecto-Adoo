    ...
    <div class="container-fluid">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
            <li><a class="dropdown-item" href="./html/productosVendedor.php?registro=0"><i class="bi bi-list-ol"></i> Administrar productos</a></li>
            <li><a class="dropdown-item" href="./html/registrarProductoNuevo.php"><i class="bi bi-plus-circle"></i> Publicar nuevo Producto</a></li>
            <li><a class="dropdown-item" href="./html/historialVentas.html"><i class="bi bi-wallet2"></i> Ventas</a></li>
          </ul>
        </li>
