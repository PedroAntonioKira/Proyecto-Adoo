...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-06-2021 a las 09:16:34
...
(9, 'Darla', 'Gonzalez', 'Caballero', 'UACM'),
(10, 'Patricio', 'Estrella', 'Rosado', 'Fondo de bikini'),
(11, 'Vendedor2', 'Paterno2', 'Materno2', 'INSTITUCION'),
(12, 'ffg', 'fgf', 'fgf', 'fgfg'),
(13, 'fdsfds', 'dfdsf', 'dfdf', 'dfdf'),
(14, 'vjhcfshjf', 'shdcshvck', 'sdhcsahjf', 'dhfcsdahgfkjfv'),
(15, 'Leoponcio', 'del monte', 'olivos', 'ESCOM'),
(16, 'Adalberto', 'Munjia', 'Larios', 'ESIME');
...
(3, '1111111111111111', '05/24', '561', 'darla_gc@vendedor.com'),
(4, '123456789101112', '06/26', '456', 'patricio_estrella@vendedor.com'),
(5, '123456789101112', '06/26', '456', 'patricio_estrella@vendedor.com'),
(6, '123456789101112', '06/26', '456', 'patricio_estrella@vendedor.com'),
(7, '1234123456785678', '03/25', '951', 'vendedor@ipn.com'),
(8, '1566949649896979', '02/26', '753', 'dsad@ded.com'),
(9, '3224569535464624', '01/01', '963', 'sdfsds@gfgdf.com'),
(10, '4125415532161346', '02/02', '852', 'sfsfs@adfd.dsd'),
(11, '123457896393564', '03/03', '123', 'jaja@hot.com'),
(12, '1233761296264652', '08/23', '789', 'ada@hotmail.com');
...
CREATE TABLE `puntos_entrega_vendedor` (
  `id` int(11) NOT NULL,
  `correo_vendedor` varchar(20) NOT NULL,
  `dia_entrega` varchar(20) NOT NULL,
  `hora_entrega` time NOT NULL,
  `transporte` varchar(20) NOT NULL,
  `linea_o_institucion` varchar(20) NOT NULL,
  `estacion_o_referencia` varchar(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
('ada@hotmail.com', '12345', '1bb91f73e9d31ea2830a5e73ce3ed328', 'SIN_VERIFICAR', 3),
...
('patricio_estrella@vendedor.com', '12345', 'f340f1b1f65b6df5b5e3f94d95b11daf', 'SIN_VERIFICAR', 3),
('prueba@prueba.com', 'Contraseña', '', 'VERIFICADO', 2),
('rodrigo@rodrigo.com', 'Contraseña', '', 'VERIFICADO', 3),
('vendedor@ipn.com', '12345', 'fc49306d97602c8ed1be1dfbf0835ead', 'SIN_VERIFICAR', 3);
...
(8, 'patricio_estrella@vendedor.com', 10),
(9, 'vendedor@ipn.com', 11),
(14, 'ada@hotmail.com', 16);
