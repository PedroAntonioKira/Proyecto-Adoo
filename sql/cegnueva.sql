...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-06-2021 a las 06:23:59
...
--
ALTER TABLE `entregas_compras`
  ADD CONSTRAINT `entregas_compras_ibfk_1` FOREIGN KEY (`id_vendedor`) REFERENCES `compras` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `entregas_compras_ibfk_2` FOREIGN KEY (`id_vendedor`) REFERENCES `vendedor` (`id`);
...
('root', '[{\"db\":\"ceg\",\"table\":\"entregas_compras\"},{\"db\":\"ceg\",\"table\":\"vendedor\"},{\"db\":\"ceg\",\"table\":\"producto\"},{\"db\":\"ceg\",\"table\":\"catalogodeproductos\"},{\"db\":\"ceg\",\"table\":\"productos_comprados\"},{\"db\":\"ceg\",\"table\":\"punto_e\"},{\"db\":\"ceg\",\"table\":\"aprobacionproductos\"},{\"db\":\"ceg\",\"table\":\"usuario\"},{\"db\":\"ceg\",\"table\":\"info\"},{\"db\":\"ceg\",\"table\":\"comprador\"}]');
...
('root', '2021-06-20 04:23:30', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"es\"}');
